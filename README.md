...
[![Build Status](https://travis-ci.org/nacos-group/nacos-sdk-go.svg?branch=master)](https://travis-ci.org/nacos-group/nacos-sdk-go) [![Go Report Card](https://goreportcard.com/badge/github.com/yefengzhichen/nacos-sdk-go-v1x)](https://goreportcard.com/report/github.com/yefengzhichen/nacos-sdk-go-v1x) ![license](https://img.shields.io/badge/license-Apache--2.0-green.svg)
...
```sh
$ go get -u github.com/yefengzhichen/nacos-sdk-go-v1x
```
## Quick Examples
* ClientConfig
